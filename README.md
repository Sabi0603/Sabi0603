...
My development journey is centered around turning ideas into working products while continuously improving my JavaScript, React, Node.js, Express, and MongoDB skills.

> **My approach:** Build with purpose. Keep the code clean. Learn from every project.
...
A modern portfolio application combining a React frontend with a Node.js, Express, and MongoDB backend.
...
A responsive frontend experience focused on clean layouts, product presentation, navigation, and mobile-friendly design.
